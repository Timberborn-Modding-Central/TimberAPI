...
namespace RoslynCSharp
{
    ...
    public abstract class ScriptAssembly : IMetadataReferenceProvider
    {
        ...
        public bool SecurityCheckAssembly(ICodeSecurityValidator restrictions)
        {
        ...
        /// <returns>True if the assembly passes security verification or false if it fails</returns>
        public virtual bool SecurityCheckAssembly(ICodeSecurityValidator restrictions, out CodeSecurityReport report)
        {
            // Skip checks
        ...
        protected virtual CodeSecurityEngine CreateSecurityEngine()
        {
            ...
            // Check for invalid assembly image
