...
public class GameSliderInt : GameSliderInt<GameSliderInt>
{
    protected override GameSliderInt BuilderInstance => this;
}

public abstract class GameSliderInt<TBuilder> : BaseBuilder<TBuilder, LocalizableSliderInt>
