...
public class MainMenuSlider : MainMenuSlider<MainMenuSlider>
{
    protected override MainMenuSlider BuilderInstance => this;
}

public abstract class MainMenuSlider<TBuilder> : BaseBuilder<TBuilder, LocalizableSlider>
