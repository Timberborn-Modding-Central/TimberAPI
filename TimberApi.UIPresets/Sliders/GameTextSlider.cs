...
public class GameTextSlider : GameTextSlider<GameTextSlider>
{
    protected override GameTextSlider BuilderInstance => this;
}

public abstract class GameTextSlider<TBuilder> : BaseBuilder<TBuilder, Slider>
