...
public class GameTextSliderInt : GameTextSliderInt<GameTextSliderInt>
{
    protected override GameTextSliderInt BuilderInstance => this;
}

public abstract class GameTextSliderInt<TBuilder> : BaseBuilder<TBuilder, SliderInt>
