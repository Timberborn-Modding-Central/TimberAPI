...
namespace TimberApi.UiBuilderSystem.PresetSystem
{
    public class TogglePresetFactory
    {
        ...
        //         .AddClass(TimberApiStyle.CheckBox.Checked.Hover.CheckboxOnHover).AddClass(TimberApiStyle.Sounds.Click).SetLocKey(locKey).SetName(name);
        //     if (width != default)
        //     {
        ...
        //         .AddClass(TimberApiStyle.CheckBox.Checked.Active.CheckmarkActive).AddClass(TimberApiStyle.Sounds.Click).SetName(name).SetLocKey(locKey);
        //     if (width != default)
        //     {
        //         toggle.SetWidth(width);
        //     }
        ...
        //     ToggleBuilder toggle = _componentBuilder.CreateToggle()
        //         .ModifyCheckMarkElement(checkmarkBuilder => checkmarkBuilder.SetHeight(size == default ? new Length(20, Pixel) : size).SetWidth(size == default ? new Length(20, Pixel) : size))
        //         .AddClass(TimberApiStyle.CheckBox.Normal.EmptyAlt).AddClass(TimberApiStyle.CheckBox.Checked.Normal.CheckmarkAlt).AddClass(TimberApiStyle.Sounds.Click).SetName(name)
        //         .SetLocKey(locKey);
        //     if (width != default)
        //     {
        //         toggle.SetWidth(width);
        ...
        //         .AddClass(TimberApiStyle.CheckBox.Checked.Hover.CircleOnHover).AddClass(TimberApiStyle.Sounds.Click).SetName(name).SetLocKey(locKey);
        //     if (width != default)
        //     {
        //         toggle.SetWidth(width);
        //     }
