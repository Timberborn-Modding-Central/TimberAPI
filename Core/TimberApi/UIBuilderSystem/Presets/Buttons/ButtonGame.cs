...
{
    public class ButtonGame : ButtonGame<ButtonGame>
    {
        protected override ButtonGame BuilderInstance => this;
    }
        ...
        where TBuilder : BaseBuilder<TBuilder, LocalizableButton>
    {
        ...
        protected override void InitializeStyleSheet(StyleSheetBuilder styleSheetBuilder)
        {
            styleSheetBuilder
                ...
                .AddNineSlicedBackgroundClass("api__button__game-button", "ui/images/buttons/button-game-hover", 24, 0.5f, PseudoClass.Hover)
                
                .AddNineSlicedBackgroundClass("api__button__game-button--normal", "ui/images/buttons/button-game", 24, 0.5f)
                .AddNineSlicedBackgroundClass("api__button__game-button--highlight", "ui/images/buttons/button-game-highlight", 24, 0.5f)
                .AddNineSlicedBackgroundClass("api__button__game-button--district", "ui/images/buttons/button-game-district", 24, 0.5f)
                .AddNineSlicedBackgroundClass("api__button__game-button--destructive", "ui/images/buttons/button-game-disabled", 24, 0.5f)
                .AddNineSlicedBackgroundClass("api__button__game-button--active", "ui/images/buttons/button-game-active", 24, 0.5f, PseudoClass.Hover, PseudoClass.Active);
        }
