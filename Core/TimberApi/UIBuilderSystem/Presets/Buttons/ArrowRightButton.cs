        ...
        where TBuilder : BaseBuilder<TBuilder, Button>
    {
        ...
        protected override void InitializeStyleSheet(StyleSheetBuilder styleSheetBuilder)
        {
            styleSheetBuilder
                ...
                .AddBackgroundClass("api__button__arrow_right-button", "ui/images/buttons/arrow-right-hover", PseudoClass.Hover)
                ...
                .AddBackgroundClass("api__button__arrow_right-button--active", "ui/images/buttons/arrow-right-active", PseudoClass.Active, PseudoClass.Hover)
