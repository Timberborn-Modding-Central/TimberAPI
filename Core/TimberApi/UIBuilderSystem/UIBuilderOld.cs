...
namespace TimberApi.UiBuilderSystem
{
    public class UIBuilderOld
    {
        ...
        //
        // public UIBuilderOld(ComponentBuilder componentBuilder, IResourceAssetLoader resourceAssetLoader, VisualElementInitializer visualElementInitializer)
        // {
