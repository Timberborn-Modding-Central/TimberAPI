...
namespace TimberApi.Core.CompatibilitySystem
{
    public class CompatibilityVisualizer : MonoBehaviour
    {
        ...
        private void ShowCompatibilityErrorElement()
        {
            ...
            var errorMessageWrapper = new VisualElement
            {
                style =
                {
                    unityFontStyleAndWeight = FontStyle.Bold, color = Color.white, fontSize = 20, width = 650,
                    paddingLeft = 10, backgroundColor = Color.red, marginLeft = 50, marginTop = 50
                }
            };
