...
{
    internal static class ConsoleHeaderUi
    {
        public static VisualElement Create()
        {
            ...
            settingsBox.Add(new Button
            {
                name = "SettingsButton", text = "Settings",
                style =
                {
                    width = 100, fontSize = 16, marginBottom = 3, marginTop = 3, color = Color.white,
            ...
            actionBox.Add(new Button
            {
                name = "CopyFullLogButton", text = "Copy log",
                style = {width = 200, height = 40, fontSize = 25, color = Color.white}
            });
            actionBox.Add(new Button
            {
                name = "CopySelectionButton", text = "Copy selection",
                style = {width = 200, height = 40, fontSize = 25, color = Color.white}
            });
