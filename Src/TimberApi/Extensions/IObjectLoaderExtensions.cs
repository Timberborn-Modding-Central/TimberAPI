...
{
    public static T GetValueOrDefault<T>(this IObjectLoader objectLoader, PropertyKey<T> key, T defaultValue)
        where T : Component
    {
    ...
    public static string GetValueOrDefault(this IObjectLoader objectLoader, PropertyKey<string> key,
        string defaultValue)
    {
        return !objectLoader.Has(key) ? defaultValue : objectLoader.Get(key);
    }
    ...
    public static Quaternion GetValueOrDefault(this IObjectLoader objectLoader, PropertyKey<Quaternion> key,
        Quaternion defaultValue)
    {
        return !objectLoader.Has(key) ? defaultValue : objectLoader.Get(key);
    }

    public static Vector3 GetValueOrDefault(this IObjectLoader objectLoader, PropertyKey<Vector3> key,
        Vector3 defaultValue)
    {
        return !objectLoader.Has(key) ? defaultValue : objectLoader.Get(key);
    }

    public static Vector3Int GetValueOrDefault(this IObjectLoader objectLoader, PropertyKey<Vector3Int> key,
        Vector3Int defaultValue)
    {
        return !objectLoader.Has(key) ? defaultValue : objectLoader.Get(key);
    }

    public static Vector2 GetValueOrDefault(this IObjectLoader objectLoader, PropertyKey<Vector2> key,
        Vector2 defaultValue)
    {
        return !objectLoader.Has(key) ? defaultValue : objectLoader.Get(key);
    }

    public static Vector2Int GetValueOrDefault(this IObjectLoader objectLoader, PropertyKey<Vector2Int> key,
