...
public class MainMenuTextSliderInt : MainMenuTextSliderInt<MainMenuTextSliderInt>
{
    protected override MainMenuTextSliderInt BuilderInstance => this;
}

public abstract class MainMenuTextSliderInt<TBuilder> : BaseBuilder<TBuilder, SliderInt>
    where TBuilder : BaseBuilder<TBuilder, SliderInt>
{
    protected SliderIntBuilder SliderIntBuilder = null!;
    ...
    {
        SliderIntBuilder.SetLabel(text);
    ...
    protected override SliderInt InitializeRoot()
    {
        SliderIntBuilder = UIBuilder.Create<SliderIntBuilder>()
    ...
    public override SliderInt Build()
    {
