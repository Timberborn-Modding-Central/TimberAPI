...
public partial class StyleSheetBuilder
{
    ...
    public StyleSheetBuilder AddNineSlicedBackground(string selector, string imagePath, float sliceTop,
    ...
    public StyleSheetBuilder AddNineSlicedBackgroundClass(string className, string imagePath, float sliceTop,
        float sliceRight, float sliceBottom, float sliceLeft, float sliceScale)
    {
        AddClass(className,
            builder => builder.NineSlicedBackgroundImage(imagePath, sliceTop, sliceRight, sliceBottom, sliceLeft,
    ...
    public StyleSheetBuilder AddNineSlicedBackgroundType(SelectorType selectorType, string imagePath, float sliceTop,
        float sliceRight, float sliceBottom, float sliceLeft, float sliceScale)
    {
    ...
    public StyleSheetBuilder AddNineSlicedBackgroundId(string idName, string imagePath, float sliceTop,
        float sliceRight, float sliceBottom, float sliceLeft, float sliceScale)
    {
        AddId(idName,
            builder => builder.NineSlicedBackgroundImage(imagePath, sliceTop, sliceRight, sliceBottom, sliceLeft,
